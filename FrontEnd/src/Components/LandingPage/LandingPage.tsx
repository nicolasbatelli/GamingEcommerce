...
export default function LandingPage() {
    ...
    const [isLoading, setIsLoading] = useState(false); // create Is Loading
    const [products, setProducts] = useState<Product[]>([]);

    useEffect(()=> {
      ProductService(setProducts, buildQueryString(), setError, setIsLoading);
    }, []);      

    function buildQueryString () {
      return "?q=" + ((inputText) ? "title : " + inputText : "") + ((minPrice) ? ",salePrice < " + minPrice.toString() : "") + ((maxPrice) ? ",salePrice > " + maxPrice.toString() : "");
    }
    ...
    return (
        <div className={classes.root}>
            ...
            <PriceFilter onChangeMinPrice={minPriceChangeHandler} onChangeMaxPrice={maxPriceChangeHandler}/>
            <Button onClick={upDateSearchHandler}
                    variant="contained"
                    color="primary"
